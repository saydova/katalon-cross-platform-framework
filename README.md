...
Execution
Running BDD Scenarios (bdd branch):
Open the project in Katalon Studio.

Navigate to Include/features/ and open any .feature file.

Click the Run button to execute directly via the Cucumber runner, or execute the corresponding runner Test Case located in Test Cases/.
